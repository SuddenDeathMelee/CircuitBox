...
pins
*/
void _74163::pin_to_output(logic_object* output, int pin_input, int pin_output){
...
*/
void _74163::input_to_pin(logic_object* input, int pin){
	inputs[pin]=input;
}
...
*/
bool _74163::evaluate_pin(int pin){
	if(!inputs[0]){
		outputs[pin]=0;
		return false;
	}
	else if(!inputs[1]){
		outputs[pin]=inputs[pin+4];
	}
...
*/
bool _74163::restructure_pin(int pin){
...
*/
vector<bool> _74163::value(logic_object* obj){
...
*/
bool _74163::value(logic_object* obj, int pin_){
	int value;
	list<pin> pin_numbers= pins[obj];
	list<pin>::iterator pin_itr= pin_numbers.begin();
...
to a logic_object.
*/
bool _74163::output_connected(int pin){
