...
pins
*/
void _7404::pin_to_output(logic_object* output, int pin_input, int pin_output){
...
*/
void _7404::input_to_pin(logic_object* input, int pin){
	inputs[pin]=input;
}
...
*/
bool _7404::evaluate_pin(int pin){
	if(inputs[pin]!=NULL){
...
*/
bool _7404::restructure_pin(int pin){
...
*/
vector<bool> _7404::value(logic_object* obj){
...
*/
bool _7404::value(logic_object* obj, int pin_){
	int value;
	list<pin> pin_numbers= pins[obj];
	list<pin>::iterator pin_itr= pin_numbers.begin();
...
to a logic_object.
*/
bool _7404::output_connected(int pin){
