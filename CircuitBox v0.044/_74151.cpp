...
pins
*/
void _74151::pin_to_output(logic_object* output, int pin_input, int pin_output){
...
*/
void _74151::input_to_pin(logic_object* input, int pin){
	inputs[pin]=input;
}
...
*/
bool _74151::evaluate_pin(int pin){
	/*
...
*/
bool _74151::restructure_pin(int pin){
...
*/
vector<bool> _74151::value(logic_object* obj){
...
*/
bool _74151::value(logic_object* obj, int pin_){
	int value;
	list<pin> pin_numbers= pins[obj];
	list<pin>::iterator pin_itr= pin_numbers.begin();
...
to a logic_object.
*/
bool _74151::output_connected(int pin){
