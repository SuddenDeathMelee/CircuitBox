...
pins
*/
void _7408::pin_to_output(logic_object* output, int pin_input, int pin_output){
...
*/ 
void _7408::input_to_pin(logic_object* input, int pin){
	inputs[pin]=input;
}
...
*/
bool _7408::evaluate_pin(int pin){
	outputs[pin]=true;
...
*/
bool _7408::restructure_pin(int pin){
...
*/
vector<bool> _7408::value(logic_object* obj){
...
*/
bool _7408::value(logic_object* obj, int pin_){
	int value;
	list<pin> pin_numbers= pins[obj];
	list<pin>::iterator pin_itr= pin_numbers.begin();
...
to a logic_object.
*/
bool _7408::output_connected(int pin){
